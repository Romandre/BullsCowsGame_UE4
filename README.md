...
The Cows correspond to characters which exist in a hidden word. The Bulls correspond to characters which not only exist in a hidden word but also placed correctly.
